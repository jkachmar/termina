{
  ...
  # TODO: This option will be available in NixOS 23.05.
  # zramSwap.writebackDevice = "/dev/zvol/oasis/swap-writeback";
  ...
  environment.etc."machine-id".source = "/secrets/oasis/machine-id";
